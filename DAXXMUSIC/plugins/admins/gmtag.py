...
@app.on_message(filters.command(["gntag", "goodnighttag" ], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
...
@app.on_message(filters.command(["gmtag", "goodmorningtag"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
...
@app.on_message(filters.command(["gmstop", "gnstop", "cancle", "stoptag", "offtag", "tagoff", "off"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))

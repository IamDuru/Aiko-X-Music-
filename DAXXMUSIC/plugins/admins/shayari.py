...
@app.on_message(filters.command(["shayari", "shayaritag", "shtag" ], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
...
@app.on_message(filters.command(["shstop", "shayarioff", "cancle", "stoptag", "offtag", "tagoff", "off"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
